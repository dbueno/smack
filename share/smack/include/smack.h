...
#define __VERIFIER_assert(EX) do { __SMACK_dummy(EX); __SMACK_code("AssertStmt(NeqExpr(@, VarExpr('$0.i32')))", EX); } while (0)
#define __VERIFIER_assume(EX) do { __SMACK_dummy(EX); __SMACK_code("AssumeStmt(NeqExpr(@, VarExpr('$0.i32')))", EX); } while (0)
